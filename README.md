...
**[ToDo]** is a minimalist todo list app.
...
```sh
  cd my-folder
  git clone https://github.com/Anand8317/react-todo-app.git
```
...
Feel free to check the [issues page](https://github.com/Anand8317/react-todo-app/issues).
